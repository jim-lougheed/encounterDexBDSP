      ...
      <form className="route__form">
        ...
        >
          ...
          <optgroup label="Lake areas">
            ...
            <option value="acuity-lakefront-area">Acuity Lakefront</option>
            <option value="valor-lakefront-area">Valor Lakefront</option>
          </optgroup>

          <optgroup label="Great Marsh">
          ...
          <optgroup label="Snowpoint Temple">
          ...
          <optgroup label="Other">
            ...
            <option value="stark-mountain-inside">
            ...
            <option value="ruin-maniac-tunnel-26-plus-different-unown-caught">
